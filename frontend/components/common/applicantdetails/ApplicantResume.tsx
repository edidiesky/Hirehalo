        ...
        <div className='px-4 py-6 border rounded-lg'>
            <div className="w-full flex flex-col gap-4">
                <div className="flex flex-col gap-4">
                    <h4 className="text-lg lg:text-xl family2 family2">Professional Experience</h4>
                ...
                <div className="flex flex-col gap-3">
                    <h4 className="text-lg lg:text-xl family2 family2">Professional Experience</h4>
                    <ol className="list-disc pl-4 lg:pl-8 flex-col gap-3 flex">
                        <li className="flex flex-col gap-2">
                            <span className="text-lg lg:text-lg family2 family2">Bitnorm</span>
                            <ol className="text-sm font-normal list-disc pl-4 lg:pl-6 flex-col gap-1 flex">
                                <li>
                ...
                <div className="flex flex-col gap-4">
                    <h4 className="text-lg lg:text-xl family2 family2">Skills and Expertise</h4>
                    <div className="flex w-full flex-wrap gap-2 items-center">
                        <span className="text-sm bg-[#deddff72] p-2 rounded-md family2 text-[#3e3aff]">
                            React.js
                        </span>
                        <span className="text-sm bg-[#deddff72] p-2 rounded-md family2 text-[#3e3aff]">
                            Next.js
