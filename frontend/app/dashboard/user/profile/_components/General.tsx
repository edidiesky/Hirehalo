...
const General = () => {
    ...
    return <div className='w-full flex flex-col gap-8'>
        <h4 className="family2 text-xl md:text-2xl font-semibold">General Information</h4>
        <form action="" className='w-full flex flex-col gap-4 py-12 px-6 border rounded-lg relative'>
            ...
            <button className="text-sm mt-4 max-w-[300px] md:text-base btn btn_1">Save new Information</button>
