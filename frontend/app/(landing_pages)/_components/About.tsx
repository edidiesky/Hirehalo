...
const About = () => {
    return <div className='flex w-full py-20 items-center bg-[#fafafa] gap-8 justify-center'>
        <div className="max-w-custom mx-auto w-[90%] grid lg:grid-cols-custom lg:items-center gap-12 lg:gap-20">
            <div className="w-full">
                <h2 className="text-3xl lg:text-5xl leading-[1.3] capitalize text-dark family2">
                    <AnimateTextWord>
            ...
            <div className="w-full lg:w-[500px] grid sm:grid-cols-2 lg:grid-cols-2 gap-8 lg:gap-12">
                <h3 className="text-6xl leading-[1.2] flex-1 text-start lg:text-6xl font-normal">
                    <AnimateTextWord type='bigtext'>
                        90%
                    </AnimateTextWord>

                    <span className="block pt-2 text-lg md:text-lg max-w-[300px]">
                        <AnimateTextWord>
